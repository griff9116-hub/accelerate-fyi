...
export const metadata: Metadata = {
  title: "German Startup Accelerators & VCs (2025)",
  description: "The best startup accelerators, venture studios, and investors in Germany — Berlin, Munich, Hamburg and beyond.",
};
...
export default async function GermanyPage() {
  ...
  return (
    <div className="mx-auto max-w-7xl px-4 py-12 sm:px-6">
      <div className="mb-10">
        <p className="mb-2 text-sm text-zinc-500"><Link href="/europe" className="hover:text-zinc-300">Europe</Link> / Germany</p>
        <h1 className="text-4xl font-bold text-white">German Startup Accelerators &amp; Investors</h1>
        <p className="mt-3 text-zinc-400">{programmes.length} programmes in Germany.</p>
      </div>

      <AdSlot slot="category-germany" format="horizontal" className="mb-6" />

      {programmes.length === 0 ? (
        <div className="rounded-xl border border-dashed border-zinc-800 p-16 text-center">
          <p className="text-zinc-500">German programmes coming soon.</p>
