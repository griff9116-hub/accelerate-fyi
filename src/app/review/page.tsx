...
export default function ReviewPage() {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    try {
      ...
      const res = await fetch("/api/review-deck", { method: "POST", body: form });
    ...
    <div className="mx-auto max-w-4xl px-4 py-12 sm:px-6">
      ...
      <div className="mb-10 text-center">
        <div className="mb-3 inline-flex items-center gap-2 rounded-full border border-indigo-500/30 bg-indigo-500/10 px-3 py-1 text-xs font-medium text-indigo-400">
          ...
          AI-powered deck review
        </div>
        <h1 className="text-3xl font-bold text-white sm:text-4xl">Get your deck reviewed</h1>
