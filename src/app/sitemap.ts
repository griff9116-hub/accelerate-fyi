...
export default async function sitemap(): Promise<MetadataRoute.Sitemap> {
  ...
  const static_routes = [
    ...
    { url: `${BASE}/europe`, changeFrequency: "weekly" as const, priority: 0.85 },
    { url: `${BASE}/germany`, changeFrequency: "weekly" as const, priority: 0.8 },
    { url: `${BASE}/france`, changeFrequency: "weekly" as const, priority: 0.8 },
    { url: `${BASE}/netherlands`, changeFrequency: "weekly" as const, priority: 0.75 },
